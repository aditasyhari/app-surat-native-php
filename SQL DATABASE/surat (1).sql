...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 06, 2021 at 09:32 AM
...
INSERT INTO `arsip_file` (`id_arsip`, `id_user`, `id_klasifikasi`, `no_arsip`, `tgl_arsip`, `keamanan`, `ket`, `file_arsip`, `tgl_upload`) VALUES
(1, '1', '12', '1', '2021-03-03', 'Biasa/Terbuka', 'tesss', 'ARSIP_adit-docx_2021-03-03.docx', '2021-03-03'),
(2, '1', '12', '2', '2021-03-02', 'Terbatas', 'coba', 'ARSIP_214-article-text-482-1-10-20190521-pdf_2021-03-02.pdf', '2021-03-03'),
(3, '1', '12', '3', '2021-03-01', 'Rahasia', 'bola', 'ARSIP_bola-jpg_2021-03-01.jpg', '2021-03-03'),
(4, '1', '12', '4', '2021-03-03', 'Sangat Rahasia', 'jersey', 'ARSIP_jersey-man-city-jpg_2021-03-03.jpg', '2021-03-03'),
(5, '1', '', '5', '2021-03-04', 'Biasa/Terbuka', 'file zip', 'ARSIP_abstract-colorful-shapes-background-zip_2021-03-04.zip', '2021-03-03'),
(6, '1', '12', '6', '2021-03-03', 'Biasa/Terbuka', 'jpeg', 'ARSIP_gnl-jpeg_2021-03-03.jpeg', '2021-03-03');
...
(1, '1', '0001/29/SM/2021', '1', NULL, '8765', '2021-03-03', '40', 'admin', 'baldes', 'makan', 'bnm', 'SK_2021-03-03_makan_03-03-2021_00-47-20.jpg', '2021-03-03 00:47:20'),
(2, '1', '0001/03/SM/2021', '1', NULL, '765', '2021-03-03', '14', 'admin', 'poliwangi', 'tes', 'dfghjkl', 'SK_2021-03-03_tes_03-03-2021_00-48-11.png', '2021-03-03 00:48:11');
...
(4, '1', '777', '2021-03-02', '0001/LPR/SM/2021', '0001/LPR/SM/2021', '14', '2021-03-01', 'adit korostar', '[\"1\",\"90\"]', 'tess', 'tessss', 'SM_02-03-2021_16-20-55_gnl.jpeg', NULL, '2021-03-02 15:52:22');
...
INSERT INTO `derajat` (`id_derajat`, `nama`, `created`, `updated`) VALUES
(1, 'Biasa', '2021-02-23 14:02:52', '2021-02-23 14:07:47'),
(3, 'Segera', '2021-02-23 14:07:59', '2021-02-23 14:07:59'),
(4, 'Sangat segera', '2021-02-23 14:08:06', '2021-02-23 14:08:06');
...
(7, '1', '[\"86\",\"79\"]', 'memo tes tetetet', 'isi memeooooo shabha', 'Memo_03-03-2021_19-19-53.pdf', '2021-03-03 19:18:58');
...
INSERT INTO `karakteristik` (`id_karakteristik`, `nama`, `created`, `updated`) VALUES
(7, 'Surat terbatas', '2021-02-23 14:09:07', '2021-02-23 14:09:07'),
(8, 'Surat rahasia', '2021-02-23 14:09:19', '2021-02-23 14:09:19'),
(12, 'Surat biasa', '2021-03-03 19:27:16', '2021-03-03 19:27:16');
...
(14, 'tss', '2021-03-05 13:34:24', '2021-03-05');
...
(12, 'A-2', 'PERATURAN KAPOLDA', '2021-02-23 17:45:21', '2018-05-09'),
(13, 'B2', 'KEPUTUSAN KAPOLDA', '2021-02-23 17:45:37', '2018-05-09'),
...
INSERT INTO `kontak` (`id_kt`, `id_user`, `nama`, `perusahaan`, `email`, `telepon`, `alamat`, `created`) VALUES
(15, '1', 'admin', 'aaakk', 'admin@gmail.com', '09887761541', 'bbbbb', '2021-03-06 15:28:07');
...
--
-- Table structure for table `libur_pekan`
--

CREATE TABLE `libur_pekan` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `libur_pekan`
--

INSERT INTO `libur_pekan` (`id`, `dow`, `created`) VALUES
(1, 'null', '2021-03-05');
...
CREATE TABLE `memo` (
  ...
  `file_memo` tinytext DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
(3, '90', '4', '[\"1\"]', '[\"86\"]', 'tess catatan', '2021-03-02 17:11:27', NULL, NULL);
...
(1, '\n&lt;p&gt;E - Office&lt;/p&gt;\n', '\n&lt;p&gt;Aplikasi Surat Menyurat&lt;/p&gt;\n', 'KOP_09-05-2018_12-47-46.jpg', '1', '=KodeSurat=/SM/=Tahun=', '1', 'B/=KodeSurat=/=Bulan=/KKA/=Tahun=', '1', 'KAPOLDA/=KodeSurat=/=Bulan=/KKA/=Tahun=', 'admin@gmail.com', 'passwordadmin', '2021-03-02 14:36:07');
...
CREATE TABLE `status_surat` (
  ...
  `ket` tinytext NOT NULL,
  `file_progress` varchar(100) DEFAULT NULL,
  `created` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(9, '4', '1', '1', 'djndjs', NULL, '2021-03-02 17:19:19');
...
CREATE TABLE `surat_keluar` (
  ...
  `tgl_surat_fisik` date NOT NULL,
  `perihal` varchar(255) NOT NULL,
  `karakteristik` int(11) NOT NULL,
  `derajat` int(11) NOT NULL,
  `layout_konten` text NOT NULL,
  `layout_kop` text DEFAULT NULL,
  `logo_kop` varchar(255) DEFAULT NULL,
...
INSERT INTO `surat_keluar` (`id_skeluar`, `nomor_surat`, `jenis_surat`, `pembuat`, `tujuan`, `tgl_surat_fisik`, `perihal`, `karakteristik`, `derajat`, `layout_konten`, `layout_kop`, `logo_kop`, `id_template`, `created`, `updated`) VALUES
(23, '001/A-2/II/2021', 12, 3, 'kdakn', '2021-02-25', 'jbj', 6, 1, '<!DOCTYPE html>\r\n<html>\r\n<head>\r\n</head>\r\n<body>\r\n<p>tfgxcgf</p>\r\n</body>\r\n</html>', NULL, NULL, NULL, '2021-02-24 14:21:51', '2021-02-24 14:21:51'),
(29, '002/B2/II/2021', 13, 2, 'jbsjfbsj', '2021-02-24', 'mvsv', 6, 1, '<!DOCTYPE html>\r\n<html>\r\n<head>\r\n</head>\r\n<body>\r\n<p>002/B2/II/2021</p>\r\n</body>\r\n</html>', NULL, NULL, NULL, '2021-02-24 14:27:52', '2021-02-24 14:27:52'),
(33, '003/B2/II/2021', 13, 1, 'Poliwangi', '2021-02-26', 'Undangan Makan', 6, 3, '<!DOCTYPE html>\r\n<html>\r\n<head>\r\n</head>\r\n<body>\r\n<p style=\"margin-bottom: 0in; line-height: 100%; text-align: right;\" align=\"right\"><font face=\"Times New Roman, serif\"><font style=\"font-size: 12pt;\" size=\"3\">Banyuwangi, 26 Februari 2021<br /></font></font></p>\r\n<p style=\"margin-bottom: 0in; line-height: 100%;\" align=\"justify\">&nbsp;</p>\r\n<p style=\"margin-bottom: 0in; line-height: 100%;\" align=\"justify\"><font face=\"Times New Roman, serif\"><font style=\"font-size: 12pt;\" size=\"3\">No : 003/B2/II/2021<br /></font></font></p>\r\n<p style=\"margin-bottom: 0in; line-height: 100%;\" align=\"justify\"><font face=\"Times New Roman, serif\"><font style=\"font-size: 12pt;\" size=\"3\">Perihal : Undangan Makan<br /></font></font></p>\r\n<p style=\"margin-bottom: 0in; line-height: 100%;\" align=\"justify\">&nbsp;</p>\r\n<p style=\"margin-bottom: 0in; line-height: 100%;\" align=\"justify\"><font face=\"Times New Roman, serif\"><font style=\"font-size: 12pt;\" size=\"3\">Kepada</font></font></p>\r\n<p style=\"margin-bottom: 0in; line-height: 100%;\" align=\"justify\"><font face=\"Times New Roman, serif\"><font style=\"font-size: 12pt;\" size=\"3\">Yth. Seluruh Dosen</font></font></p>\r\n<p style=\"margin-bottom: 0in; line-height: 100%;\" align=\"justify\"><font face=\"Times New Roman, serif\"><font style=\"font-size: 12pt;\" size=\"3\">di Poliwangi</font></font></p>\r\n<p style=\"margin-bottom: 0in; line-height: 100%;\" align=\"justify\">&nbsp;</p>\r\n<p style=\"margin-bottom: 0in; line-height: 100%;\" align=\"justify\"><font face=\"Times New Roman, serif\"><font style=\"font-size: 12pt;\" size=\"3\">Dengan hormat,</font></font></p>\r\n<p style=\"margin-top: 0.17in; margin-bottom: 0.11in; line-height: 100%;\"><font face=\"Times New Roman, serif\"><font style=\"font-size: 12pt;\" size=\"3\">Diberitahukan kepada seluruh guru yang ada di pemerintahan Kabupaten Kulon Progo untuk memperingati hari Guru nasional maka Dinas Pendidikan Kabupaten Kulon Progo akan mengadakan upacara, yang akan dilaksanakan:</font></font></p>\r\n<table style=\"height: 132px;\" width=\"601\" cellspacing=\"0\" cellpadding=\"7\"><colgroup><col width=\"90\" /> <col width=\"483\" /> </colgroup>\r\n<tbody>\r\n<tr style=\"height: 44px;\" valign=\"top\">\r\n<td style=\"padding: 0in; height: 44px;\" width=\"90\">\r\n<p><font face=\"Times New Roman, serif\"><font style=\"font-size: 12pt;\" size=\"3\">Hari/tanggal</font></font></p>\r\n</td>\r\n<td style=\"padding: 0in; height: 44px;\" width=\"483\">\r\n<p><font face=\"Times New Roman, serif\"><font style=\"font-size: 12pt;\" size=\"3\">: Senin, 20 April 2021</font></font></p>\r\n</td>\r\n</tr>\r\n<tr style=\"height: 44px;\" valign=\"top\">\r\n<td style=\"padding: 0in; height: 44px;\" width=\"90\">\r\n<p><font face=\"Times New Roman, serif\"><font style=\"font-size: 12pt;\" size=\"3\">Tempat</font></font></p>\r\n</td>\r\n<td style=\"padding: 0in; height: 44px;\" width=\"483\">\r\n<p><font face=\"Times New Roman, serif\"><font style=\"font-size: 12pt;\" size=\"3\">: Basecamp Pengatigan</font></font></p>\r\n</td>\r\n</tr>\r\n<tr style=\"height: 44px;\" valign=\"top\">\r\n<td style=\"padding: 0in; height: 44px;\" width=\"90\">\r\n<p><font face=\"Times New Roman, serif\"><font style=\"font-size: 12pt;\" size=\"3\">Pukul</font></font></p>\r\n</td>\r\n<td style=\"padding: 0in; height: 44px;\" width=\"483\">\r\n<p><font face=\"Times New Roman, serif\"><font style=\"font-size: 12pt;\" size=\"3\">: 08.00 WIB sampai selesai</font></font></p>\r\n</td>\r\n</tr>\r\n</tbody>\r\n</table>\r\n<p style=\"margin-top: 0.17in; margin-bottom: 0.11in; line-height: 100%;\"><font face=\"Times New Roman, serif\"><font style=\"font-size: 12pt;\" size=\"3\">Maka diharapkan bahwasannya semua guru di lingkungan pemerintahan Kabupaten Kulon Progo diwajibkan untuk mengikuti upacara tersebut dengan menggunakan seragam kopri.</font></font></p>\r\n<p style=\"margin-top: 0.17in; margin-bottom: 0.11in; line-height: 100%;\"><font face=\"Times New Roman, serif\"><font style=\"font-size: 12pt;\" size=\"3\">Demikian surat ini diberitahukan, atas segenap perhatiannya kami ucapkan banyak terimakaasih.</font></font></p>\r\n<p style=\"margin-left: 4.5in; margin-top: 0.17in; margin-bottom: 0.11in; line-height: 100%;\" align=\"justify\"><font face=\"Times New Roman, serif\"><font style=\"font-size: 12pt;\" size=\"3\">Kepala Dinas Pendidikan</font></font></p>\r\n<p style=\"margin-left: 4.5in; margin-top: 0.17in; margin-bottom: 0.11in; line-height: 100%;\" align=\"justify\"><br /><br /></p>\r\n<p style=\"margin-left: 4.5in; margin-top: 0.17in; margin-bottom: 0.11in; line-height: 100%;\" align=\"justify\"><font face=\"Times New Roman, serif\"><font style=\"font-size: 12pt;\" size=\"3\">Dr. Khoirul Nur, M.Ag.</font></font></p>\r\n<p style=\"margin-left: 4.5in; margin-top: 0.17in; margin-bottom: 0.11in; line-height: 100%;\" align=\"justify\"><font face=\"Times New Roman, serif\"><font style=\"font-size: 12pt;\" size=\"3\">NIP. 987654321101918</font></font></p>\r\n<p>&nbsp;</p>\r\n</body>\r\n</html>', NULL, NULL, NULL, '2021-02-25 16:44:15', '2021-02-25 16:49:30'),
(34, '001/34/II/2021', 45, 1, 'Balai Desa Temuguruh Sempu banyuwangi', '2021-02-26', 'Undangan Makan', 8, 4, '<!DOCTYPE html>\r\n<html>\r\n<head>\r\n</head>\r\n<body>\r\n<p class=\"western\" style=\"margin-bottom: 0in; line-height: 100%;\" align=\"center\"><u><strong>SURAT KUASA KHUSUS</strong></u></p>\r\n<p class=\"western\" style=\"margin-bottom: 0in; line-height: 100%;\" align=\"center\"><strong>NO. 001/34/II/2021<br /></strong></p>\r\n<p class=\"western\" style=\"margin-bottom: 0in; line-height: 100%;\" align=\"center\">&nbsp;</p>\r\n<p class=\"western\" style=\"margin-bottom: 0in; line-height: 100%;\" align=\"justify\">Yang bertanda tangan di bawah ini :</p>\r\n<p class=\"western\" style=\"margin-bottom: 0in; line-height: 100%;\" align=\"justify\">Nama : &nbsp;Administrator</p>\r\n<p class=\"western\" style=\"margin-bottom: 0in; line-height: 100%;\" align=\"justify\">Umur : Undangan Makan</p>\r\n<p class=\"western\" style=\"margin-bottom: 0in; line-height: 100%;\" align=\"justify\">Pekerjaan : nganggur</p>\r\n<p class=\"western\" style=\"margin-bottom: 0in; line-height: 100%;\" align=\"justify\">Alamat : Rogojampi</p>\r\n<p class=\"western\" style=\"margin-bottom: 0in; line-height: 100%;\" align=\"justify\">Advokat/Konsultan Hukum / Anggota dari Lembaga Bantuan Hukum Siliwangi yang berkedudukan di Jl. Raya Cibogo Sukajadi Karangtengah Cianjur ( Kantor Cabang Sukabumi Jl. Marga 7 Blok A No.8 Jayaraksa ) Telp. 0263 285412 &ndash; 0266 7119626 Jawa Barat.</p>\r\n<p class=\"western\" style=\"margin-bottom: 0in; line-height: 100%;\" align=\"justify\">&nbsp;</p>\r\n<p class=\"western\" style=\"margin-bottom: 0in; line-height: 100%;\" align=\"justify\">----------------------------------------------KHUSUS--------------------------------------------------</p>\r\n<p class=\"western\" style=\"margin-bottom: 0in; line-height: 100%;\" align=\"justify\">&nbsp;</p>\r\n<p class=\"western\" style=\"margin-bottom: 0in; line-height: 100%;\" align=\"justify\">Untuk dan atas nama Pemberi Kuasa mendampingi, mewakili dan memberikan bantuan Hukum dalam</p>\r\n<p class=\"western\" style=\"margin-bottom: 0in; line-height: 100%;\" align=\"justify\">Surat Kuasa ini di berikan dengan hak subtitusi baik sebagian maupun seluruhnya kepada orang lain dan penerima kuasa berhak atas retensi.</p>\r\n<p class=\"western\" style=\"margin-bottom: 0in; line-height: 100%;\" align=\"justify\">&nbsp;</p>\r\n<table style=\"height: 253px; width: 481px;\" width=\"591\" cellspacing=\"0\" cellpadding=\"7\"><colgroup><col style=\"width: 240px;\" width=\"281\" /><col style=\"width: 240px;\" width=\"281\" /></colgroup>\r\n<tbody>\r\n<tr style=\"height: 319px;\" valign=\"top\">\r\n<td style=\"padding: 0in; height: 253px;\" width=\"281\">\r\n<p class=\"western\" style=\"margin-bottom: 0in;\" align=\"center\">&nbsp;</p>\r\n<p class=\"western\" style=\"margin-bottom: 0in;\" align=\"center\">Penerima Kuasa,</p>\r\n<p class=\"western\" style=\"margin-bottom: 0in;\" align=\"center\">&nbsp;</p>\r\n<ol>\r\n<li>Orang 1</li>\r\n<li>Orang 2</li>\r\n<li>Orang 3</li>\r\n<li>Orang 4</li>\r\n</ol>\r\n</td>\r\n<td style=\"padding: 0in; height: 253px;\" width=\"281\">\r\n<p class=\"western\" style=\"margin-bottom: 0in;\" align=\"center\">Sukabumi, 26 Februari 2021</p>\r\n<p class=\"western\" style=\"margin-bottom: 0in;\" align=\"center\">Pemberi Kuasa,</p>\r\n<p class=\"western\" style=\"margin-bottom: 0in;\" align=\"center\">&nbsp;</p>\r\n<p class=\"western\" style=\"margin-bottom: 0in;\" align=\"center\">&nbsp;</p>\r\n<p class=\"western\" style=\"margin-bottom: 0in;\" align=\"center\">&nbsp;</p>\r\n<p class=\"western\" style=\"margin-bottom: 0in;\" align=\"center\">&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;<strong>.</strong></p>\r\n</td>\r\n</tr>\r\n</tbody>\r\n</table>\r\n<p class=\"western\" style=\"margin-bottom: 0in; line-height: 100%;\" align=\"justify\">&nbsp;</p>\r\n<p>&nbsp;</p>\r\n</body>\r\n</html>', '<!DOCTYPE html>\r\n<html>\r\n<head>\r\n</head>\r\n<body>\r\n<p class=\"western\" style=\"margin-left: 1.13in; margin-bottom: 0in; line-height: 100%; text-align: center;\" align=\"center\"><font style=\"font-size: 16pt;\" size=\"4\"><strong>LEMBAGA BANTUAN HUKUM</strong></font></p>\r\n<p class=\"western\" style=\"margin-left: 1.13in; margin-bottom: 0in; line-height: 100%; text-align: center;\" align=\"center\"><font style=\"font-size: 16pt;\" size=\"4\"><strong>( LBH )</strong></font></p>\r\n<p class=\"western\" style=\"margin-left: 1.13in; margin-bottom: 0in; line-height: 100%; text-align: center;\" align=\"center\"><font style=\"font-size: 16pt;\" size=\"4\"><strong>SILIWANGI</strong></font></p>\r\n</body>\r\n</html>', 'KOP-TEMPLATE_25-02-2021_01-35-30_logo_bacode.png', 31, '2021-02-25 18:02:41', '2021-02-25 21:18:09');
...
CREATE TABLE `template` (
  ...
  `ukuran_hal` enum('A4','Letter') NOT NULL,
  `orientasi_hal` enum('P','L') NOT NULL,
  `m_atas` int(3) NOT NULL,
  `m_bawah` int(3) NOT NULL,
  `m_kiri` int(3) NOT NULL,
  `m_kanan` int(3) NOT NULL,
  `layout_konten` text NOT NULL,
  `status_temp` enum('pengajuan','revisi','disetujui','tolak') NOT NULL DEFAULT 'pengajuan',
  `revisi` text DEFAULT NULL,
  `nama_template` varchar(255) NOT NULL,
  `read_validator` tinyint(1) NOT NULL DEFAULT 0,
  `tgl_dibuat` datetime NOT NULL DEFAULT current_timestamp(),
  `tgl_diupdate` datetime NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `template` (`id_template`, `id_pembuat`, `layout_kop`, `logo_kop`, `id_klasifikasi`, `id_validator`, `ukuran_hal`, `orientasi_hal`, `m_atas`, `m_bawah`, `m_kiri`, `m_kanan`, `layout_konten`, `status_temp`, `revisi`, `nama_template`, `read_validator`, `tgl_dibuat`, `tgl_diupdate`) VALUES
(31, 1, '<!DOCTYPE html>\r\n<html>\r\n<head>\r\n</head>\r\n<body>\r\n<p class=\"western\" style=\"margin-left: 1.13in; margin-bottom: 0in; line-height: 100%; text-align: center;\" align=\"center\"><font style=\"font-size: 16pt;\" size=\"4\"><strong>LEMBAGA BANTUAN HUKUM</strong></font></p>\r\n<p class=\"western\" style=\"margin-left: 1.13in; margin-bottom: 0in; line-height: 100%; text-align: center;\" align=\"center\"><font style=\"font-size: 16pt;\" size=\"4\"><strong>( LBH )</strong></font></p>\r\n<p class=\"western\" style=\"margin-left: 1.13in; margin-bottom: 0in; line-height: 100%; text-align: center;\" align=\"center\"><font style=\"font-size: 16pt;\" size=\"4\"><strong>SILIWANGI</strong></font></p>\r\n</body>\r\n</html>', 'KOP-TEMPLATE_25-02-2021_01-35-30_logo_bacode.png', 45, 58, 'A4', 'P', 10, 10, 20, 10, '<!DOCTYPE html>\r\n<html>\r\n<head>\r\n</head>\r\n<body>\r\n<p class=\"western\" style=\"margin-bottom: 0in; line-height: 100%;\" align=\"center\"><u><strong>SURAT KUASA KHUSUS</strong></u></p>\r\n<p class=\"western\" style=\"margin-bottom: 0in; line-height: 100%;\" align=\"center\"><strong>NO. =NoSurat=<br /></strong></p>\r\n<p class=\"western\" style=\"margin-bottom: 0in; line-height: 100%;\" align=\"center\">&nbsp;</p>\r\n<p class=\"western\" style=\"margin-bottom: 0in; line-height: 100%;\" align=\"justify\">Yang bertanda tangan di bawah ini :</p>\r\n<p class=\"western\" style=\"margin-bottom: 0in; line-height: 100%;\" align=\"justify\">Nama : &nbsp;=Nama=</p>\r\n<p class=\"western\" style=\"margin-bottom: 0in; line-height: 100%;\" align=\"justify\">Umur :</p>\r\n<p class=\"western\" style=\"margin-bottom: 0in; line-height: 100%;\" align=\"justify\">Pekerjaan :</p>\r\n<p class=\"western\" style=\"margin-bottom: 0in; line-height: 100%;\" align=\"justify\">Alamat :</p>\r\n<p class=\"western\" style=\"margin-bottom: 0in; line-height: 100%;\" align=\"justify\">Advokat/Konsultan Hukum / Anggota dari Lembaga Bantuan Hukum Siliwangi yang berkedudukan di Jl. Raya Cibogo Sukajadi Karangtengah Cianjur ( Kantor Cabang Sukabumi Jl. Marga 7 Blok A No.8 Jayaraksa ) Telp. 0263 285412 &ndash; 0266 7119626 Jawa Barat.</p>\r\n<p class=\"western\" style=\"margin-bottom: 0in; line-height: 100%;\" align=\"justify\">&nbsp;</p>\r\n<p class=\"western\" style=\"margin-bottom: 0in; line-height: 100%;\" align=\"justify\">----------------------------------------------KHUSUS--------------------------------------------------</p>\r\n<p class=\"western\" style=\"margin-bottom: 0in; line-height: 100%;\" align=\"justify\">&nbsp;</p>\r\n<p class=\"western\" style=\"margin-bottom: 0in; line-height: 100%;\" align=\"justify\">Untuk dan atas nama Pemberi Kuasa mendampingi, mewakili dan memberikan bantuan Hukum dalam</p>\r\n<p class=\"western\" style=\"margin-bottom: 0in; line-height: 100%;\" align=\"justify\">Surat Kuasa ini di berikan dengan hak subtitusi baik sebagian maupun seluruhnya kepada orang lain dan penerima kuasa berhak atas retensi.</p>\r\n<p class=\"western\" style=\"margin-bottom: 0in; line-height: 100%;\" align=\"justify\">&nbsp;</p>\r\n<table style=\"height: 253px; width: 481px;\" width=\"591\" cellspacing=\"0\" cellpadding=\"7\"><colgroup><col style=\"width: 240px;\" width=\"281\" /><col style=\"width: 240px;\" width=\"281\" /></colgroup>\r\n<tbody>\r\n<tr style=\"height: 319px;\" valign=\"top\">\r\n<td style=\"padding: 0in; height: 253px;\" width=\"281\">\r\n<p class=\"western\" style=\"margin-bottom: 0in;\" align=\"center\">&nbsp;</p>\r\n<p class=\"western\" style=\"margin-bottom: 0in;\" align=\"center\">Penerima Kuasa,</p>\r\n<p class=\"western\" style=\"margin-bottom: 0in;\" align=\"center\">&nbsp;</p>\r\n<ol>\r\n<li>Orang 1</li>\r\n<li>Orang 2</li>\r\n<li>Orang 3</li>\r\n<li>Orang 4</li>\r\n</ol>\r\n</td>\r\n<td style=\"padding: 0in; height: 253px;\" width=\"281\">\r\n<p class=\"western\" style=\"margin-bottom: 0in;\" align=\"center\">Sukabumi, =TglSurat=</p>\r\n<p class=\"western\" style=\"margin-bottom: 0in;\" align=\"center\">Pemberi Kuasa,</p>\r\n<p class=\"western\" style=\"margin-bottom: 0in;\" align=\"center\">&nbsp;</p>\r\n<p class=\"western\" style=\"margin-bottom: 0in;\" align=\"center\">&nbsp;</p>\r\n<p class=\"western\" style=\"margin-bottom: 0in;\" align=\"center\">&nbsp;</p>\r\n<p class=\"western\" style=\"margin-bottom: 0in;\" align=\"center\">&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;<strong>.</strong></p>\r\n</td>\r\n</tr>\r\n</tbody>\r\n</table>\r\n<p class=\"western\" style=\"margin-bottom: 0in; line-height: 100%;\" align=\"justify\">&nbsp;</p>\r\n<p>&nbsp;</p>\r\n</body>\r\n</html>', 'disetujui', NULL, 'Surat Kuasa 1', 1, '2021-02-25 01:35:30', '2021-02-25 01:46:38'),
(32, 1, '<!DOCTYPE html>\r\n<html>\r\n<head>\r\n</head>\r\n<body>\r\n<p style=\"text-align: center; line-height: 1.2;\">ini kop surat</p>\r\n<p style=\"text-align: center; line-height: 1.2;\">tes kop surat</p>\r\n</body>\r\n</html>', 'KOP-TEMPLATE_26-02-2021_07-07-29_gnl.jpeg', 13, 58, 'A4', 'P', 10, 10, 40, 10, '<!DOCTYPE html>\r\n<html>\r\n<head>\r\n</head>\r\n<body>\r\n<p>isi surat tes</p>\r\n<p>=NoSurat=</p>\r\n</body>\r\n</html>', 'revisi', 'tes revisi', 'coba template', 1, '2021-02-26 07:07:29', '2021-02-26 07:12:21'),
(34, 1, '<!DOCTYPE html>\r\n<html>\r\n<head>\r\n</head>\r\n<body>\r\n<p>bdajdbja</p>\r\n</body>\r\n</html>', 'KOP-TEMPLATE_04-03-2021_16-47-38_bola.jpg', 13, 58, 'A4', 'P', 10, 10, 10, 10, '<!DOCTYPE html>\r\n<html>\r\n<head>\r\n</head>\r\n<body>\r\n<p>dbajdbaj</p>\r\n</body>\r\n</html>', 'pengajuan', NULL, 'tmp', 1, '2021-03-04 16:47:38', '2021-03-04 16:47:38');
...
(90, '123', 'USER', '28', 'user', '21232f297a57a5a743894a0e4a801fc3', '[\"1\",\"90\",\"88\",\"74\",\"91\",\"86\",\"87\",\"79\",\"82\",\"83\",\"80\",\"85\",\"77\",\"84\",\"76\",\"75\",\"81\",\"78\",\"89\"]', '', 58, '', 'sekretaris.png'),
...
(85, '123', 'URKANPOS', '40', 'URKANPOS', '21232f297a57a5a743894a0e4a801fc3', '[\"1\",\"90\",\"88\",\"74\",\"86\",\"87\",\"79\",\"82\",\"83\",\"80\",\"85\",\"77\",\"84\",\"76\",\"75\",\"81\",\"78\",\"89\"]', '', 116, '', 'sekretaris.png'),
...
(93, '1234', 'aditya', NULL, 'adit', '486b6c6b267bc61677367eb6b6458764', '[\"86\",\"87\",\"82\"]', NULL, 87, 'adit@gmail.com', 'sekretaris.png'),
(94, '1233', 'surya', NULL, 'surya', 'aff8fbcbf1363cd7edc85a1e11391173', '[\"86\",\"87\"]', NULL, 85, 'surya@gmail.com', 'sekretaris.png');
...
CREATE TABLE `user_level` (
  ...
  `template_sk` char(1) NOT NULL DEFAULT 'N',
  `edaran` char(1) DEFAULT NULL,
  `report_edaran` char(1) DEFAULT NULL,
  `log_user` char(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `user_level` (`id_user`, `sm`, `sk`, `arsip`, `cari_surat_masuk`, `cari_surat_keluar`, `template_surat`, `atur_noagenda`, `atur_layout`, `report_dispo`, `atur_klasifikasi_sm`, `atur_klasifikasi_sk`, `atur_klasifikasi_arsip`, `atur_user`, `atur_infoapp`, `report_sm`, `report_sk`, `report_arsip`, `report_progress`, `info`, `atur_tujuan_sk`, `template_sk`, `edaran`, `report_edaran`, `log_user`) VALUES
(1, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'W', '', 'Y'),
(2, 'R', 'R', 'R', 'N', 'N', 'N', 'N', '', 'Y', '', 'N', '', '', 'N', 'Y', 'Y', 'Y', '', 'N', '', 'N', '', '', ''),
(3, 'W', 'W', 'W', 'Y', 'Y', 'W', 'Y', 'N', 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', '', 'N', 'W', 'Y', ''),
(9, 'R', 'R', 'R', 'N', 'N', 'N', 'N', '', 'Y', 'N', 'N', 'N', 'Y', 'N', 'Y', 'Y', 'Y', 'Y', 'N', '', 'N', '', '', ''),
(10, 'R', 'R', 'R', 'N', 'N', 'N', 'N', 'N', 'Y', 'N', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', '', 'N', '', '', ''),
(11, 'R', 'R', 'R', 'N', 'N', 'N', 'N', 'N', 'Y', 'N', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', '', 'N', '', '', ''),
(12, '', '', '', 'N', 'N', 'N', 'N', '', '', '', 'N', '', '', 'N', '', '', '', '', 'N', '', 'N', '', '', ''),
(17, 'W', 'W', '', 'N', 'N', 'N', 'N', '', '', '', '', '', '', 'N', '', '', '', '', '', 'N', 'N', '', '', ''),
(18, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'N', '', '', ''),
(19, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'N', '', '', ''),
(20, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'Y', 'N', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'N', '', '', ''),
(21, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'Y', 'N', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'N', '', '', ''),
(22, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'Y', 'N', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'N', '', '', ''),
(23, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'Y', 'N', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'N', '', '', ''),
(24, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'Y', 'N', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'N', '', '', ''),
(25, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'Y', 'N', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'N', '', '', ''),
(26, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'Y', 'N', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'N', '', '', ''),
(27, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'Y', 'N', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'N', '', '', ''),
(28, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'Y', 'N', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'N', '', '', ''),
(29, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'Y', 'N', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'N', '', '', ''),
(30, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'Y', 'N', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'N', '', '', ''),
(31, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'Y', 'N', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'N', '', '', ''),
(32, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'Y', 'N', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'N', '', '', ''),
(33, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'Y', 'N', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'N', '', '', ''),
(34, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'Y', 'N', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'N', '', '', ''),
(35, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'Y', 'N', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'N', '', '', ''),
(36, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'Y', 'N', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'N', '', '', ''),
(37, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'Y', 'N', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'N', '', '', ''),
(38, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'Y', 'N', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'N', '', '', ''),
(39, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'Y', 'N', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'N', '', '', ''),
(40, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'Y', 'N', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'N', '', '', ''),
(41, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'Y', 'N', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'N', '', '', ''),
(42, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'Y', 'N', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'N', '', '', ''),
(43, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'Y', 'N', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'N', '', '', ''),
(44, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'Y', 'N', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'N', '', '', ''),
(45, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'Y', 'N', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'N', '', '', ''),
(46, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'Y', 'N', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'N', '', '', ''),
(47, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'Y', 'N', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'N', '', '', ''),
(48, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'Y', 'N', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'N', '', '', ''),
(50, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'N', '', '', 'N'),
(51, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'N', '', '', 'N'),
(52, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'Y', 'N', 'N', '', '', 'N'),
(53, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', '', '', 'N'),
(54, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', '', '', 'N'),
(55, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', '', '', 'N'),
(56, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', '', '', 'N'),
(57, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', '', '', 'N'),
(58, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', '', '', 'N'),
(59, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', '', '', 'N'),
(60, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'N', '', '', 'Y'),
(61, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', '', '', 'N'),
(62, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', '', '', 'N'),
(63, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', '', '', 'N'),
(64, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', '', '', 'N'),
(65, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', '', '', 'N'),
(66, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', '', '', 'N'),
(67, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', '', '', 'N'),
(68, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', '', '', 'N'),
(69, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', '', '', 'N'),
(70, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', '', '', 'N'),
(71, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', '', '', 'N'),
(72, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'N', '', '', 'Y'),
(73, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'N', '', '', 'Y'),
(74, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'N', '', '', 'Y'),
(75, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'N', '', '', 'Y'),
(76, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'N', '', '', 'Y'),
(77, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'N', '', '', 'Y'),
(78, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'N', '', '', 'Y'),
(79, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'N', '', '', 'Y'),
(80, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'N', '', '', 'Y'),
(81, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'N', '', '', 'Y'),
(82, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'N', '', '', 'Y'),
(83, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'N', '', '', 'Y'),
(84, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'N', '', '', 'Y'),
(85, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'N', '', '', 'Y'),
(86, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'Y', 'N', 'N', 'N', 'N', 'N', 'Y', 'Y', 'N', 'Y', 'Y', 'N', 'N', '', '', 'N'),
(87, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'Y', 'N', 'N', 'N', 'N', 'N', 'Y', 'Y', 'N', 'Y', 'N', 'N', 'N', '', '', 'N'),
(88, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'N', '', '', 'N'),
(89, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'N', '', '', 'N'),
(90, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'N', 'Y', 'N', 'N', 'N', 'N', 'N', 'Y', 'Y', 'N', 'Y', 'Y', 'N', 'N', '', '', 'N'),
(93, 'W', 'W', 'W', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'N', NULL, NULL, NULL),
(94, 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', NULL, NULL, NULL);
...
--
-- Indexes for table `libur_pekan`
--
ALTER TABLE `libur_pekan`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `derajat`
  MODIFY `id_derajat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `karakteristik`
  MODIFY `id_karakteristik` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `klasifikasi_sk`
  MODIFY `id_klas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;

--
-- AUTO_INCREMENT for table `kontak`
--
ALTER TABLE `kontak`
  MODIFY `id_kt` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `libur_pekan`
--
ALTER TABLE `libur_pekan`
...
--
ALTER TABLE `status_surat`
  MODIFY `id_status` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `surat_keluar`
--
ALTER TABLE `surat_keluar`
  MODIFY `id_skeluar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;

--
-- AUTO_INCREMENT for table `template`
--
ALTER TABLE `template`
  MODIFY `id_template` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
...
--
ALTER TABLE `user_jabatan`
  MODIFY `id_jab` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=241;
